      ...
      <div className="mt-12 space-y-8 border-t pt-8">
        ...
        <div className="border rounded-lg overflow-hidden">
          ...
          <Collapsible open={expandedSections.features}>
                  ...
                  <div className="bg-muted/30 p-6 rounded-lg">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between border-b border-border/50 pb-2">
                        ...
                        <span className="font-medium">{isCurrentlyInStock() ? "Yes" : "No"}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            {!expandedSections.features && (
              <div className="p-6 pt-2">
                <p className="line-clamp-2 text-muted-foreground mb-4">This product includes several key features designed to enhance your experience. View the full specifications for detailed information.</p>
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={() => toggleSection('features')}
                  className="flex items-center"
                >
                  View Full Specifications <ChevronDown className="ml-1 h-4 w-4" />
                </Button>
              </div>
            )}
          </Collapsible>
        ...
        <div className="border rounded-lg overflow-hidden">
          ...
          <Collapsible open={expandedSections.shipping}>
            ...
            {!expandedSections.shipping && (
              <div className="p-6 pt-2">
                <p className="line-clamp-2 text-muted-foreground mb-4">We offer free standard shipping on orders over $50 and a 30-day hassle-free return policy. Click below for full shipping and returns information.</p>
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={() => toggleSection('shipping')}
                  className="flex items-center"
                >
                  View Shipping & Returns <ChevronDown className="ml-1 h-4 w-4" />
                </Button>
              </div>
            )}
          </Collapsible>
